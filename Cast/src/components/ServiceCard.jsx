...
export function ServiceCard({Icon, CardTitle, Product1, Product2, Product3, Product4, Product5, Product6, Product7, Product8, Product9, Product10, Product11, Product12, Product13 }) {
  ...
  return (
    <div className="contenido_card">
      <article className="card">
        <img className="card-icon" src={`${Icon}`} alt={`${CardTitle}`} />
